                                                                                ...
                                                                                <tr>
                                                                                    <td width="100%" align="center">
                                                                                        <a href="<?=$site_settings->site_domain?>" target="_blank">
                                                                                            <img src="<?= !empty($site_settings->site_thumb) ? get_site_image_src('images', $site_settings->site_thumb) : 'https://herosolutions.com.pk/saad/open-to-world/uploads/images/opentoworld-thumb.png' ?>" style="margin: 20px auto 10px; width: 220px;" class="CToWUd" />
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
