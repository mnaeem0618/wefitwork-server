<?php echo getBredcrum(ADMIN, array('#' => 'Professional Sign Up')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">  
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Professional Sign Up</strong></h2>
    </div>
        ...
        <h3>Left Section</h3>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    <div class="col-md-4">
                            <label for="pkg_short_heading" class="control-label">Heading <span class="symbol required">*</span></label>
                            <input type="text" name="pkg_short_heading" value="<?= $row['pkg_short_heading'] ?>" class="form-control" required>
                        </div>
                        <div class="col-md-4">
                            <label class="control-label">Price</label>
                                                <div class="input-group">
                                                    <span class="input-group-addon">₦</span>
                                                <input type="number" name="pkg_price" step="any" value="<?= $row['pkg_price'] ?>" class="form-control">
                                                </div>                                                                               
                                    </div>

                                    <div class="col-md-4">
                            
                            <label for="pkg_duration" class="control-label">Duration (eg: per month) <span class="symbol required">*</span></label>
                            <input type="text" name="pkg_duration" value="<?= $row['pkg_duration'] ?>" class="form-control" required>                                                                               
                                    </div>
                        <div class="clearfix"></div>

                        <div class="col-md-12">
                            <label for="pkg_detail" class="control-label"> Text Block <span class="symbol required">*</span></label>
                            <textarea name="pkg_detail" rows="3" class="form-control ckeditor" id="editor"><?= $row['pkg_detail'] ?></textarea>
                        </div>
