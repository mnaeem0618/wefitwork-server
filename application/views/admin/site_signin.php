            ...
            <div class="form-group">
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            <label for="forgot_pswd_text" class="control-label">Forgot Text<span class="symbol required">*</span></label>
                            <input type="text" name="forgot_pswd_text" value="<?= $row['forgot_pswd_text'] ?>" class="form-control" required>
                        </div>
                        <div class="col-md-4">
