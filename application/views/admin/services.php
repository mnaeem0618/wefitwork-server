                                ...
                                <div class="panel-body">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="max-width: 310px; height: 110px;background:#eee" data-trigger="fileinput">
                                            <img src="<?= get_site_image_src("services", $row->icon)?>" alt="--">
                                        </div>
                                        ...
                                        <div>
                                            <span class="btn btn-white btn-file">
                                                ...
                                                <input type="file" name="icon" accept="image/*" <?php if(empty($row->icon)){echo 'required=""';}?>>
                                            </span>
                ...
                <?php foreach ($rows as $row): ?>
                    <tr class="odd gradeX">
                        ...
                        <td class="text-center">
                            <div class="">
                                <img src = "<?= get_site_image_src('services', $row->icon, '', false); ?>" height = "60" style="background-color:#eee">
                            </div>
                        </td>
                        <td><b><?= $row->title ?></b></td>
