...
class Dashboard extends Admin_Controller
{
    ...
    public function index()
    {
		...
		// $this->data['jobs'] = $this->master->num_rows('jobs');
        // $this->data['courses'] = $this->master->num_rows('courses',['status'=> '1']);
		$this->data['members'] = $this->master->num_rows('members');
		// $this->data['events'] = $this->master->num_rows('events');
